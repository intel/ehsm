...
def test_get_public_key(base_url, headers):
    ...
    key_EC_224 = createkey.createkey(base_url, "EH_EC_P224", "EH_INTERNAL_KEY", "EH_KEYUSAGE_SIGN_VERIFY")
    key_EC_256 = createkey.createkey(base_url, "EH_EC_P256", "EH_INTERNAL_KEY", "EH_KEYUSAGE_SIGN_VERIFY")
    key_EC_256K = createkey.createkey(base_url, "EH_EC_P256K", "EH_INTERNAL_KEY", "EH_KEYUSAGE_SIGN_VERIFY")
    key_EC_384 = createkey.createkey(base_url, "EH_EC_P384", "EH_INTERNAL_KEY", "EH_KEYUSAGE_SIGN_VERIFY")
    key_EC_521 = createkey.createkey(base_url, "EH_EC_P521", "EH_INTERNAL_KEY", "EH_KEYUSAGE_SIGN_VERIFY")
